...
class ControllerEmpresasComida {
  ...
  getempresa = () => {
    this.router.get("/empresas/comidas", (request, response) => {
      (async () => {
  ...
  // empresa.post('/empresas/comidas', function(oReq, oRes) {
  //   var oDataOP = {};
  //   var sOP = '';
  ...
  //   console.log("Los Servicios para empresa corriendo en puerto 3000");   
  // });
}
